...
public class Login extends JFrame {
	...
	public Login() {
		...
		loginUsername.setFont(new Font("Comic Sans MS", Font.BOLD, 14));

		JLabel loginPassword = new JLabel("Password");
		loginPassword.setForeground(Color.BLACK);
		loginPassword.setFont(new Font("Comic Sans MS", Font.BOLD, 14));
		...
		login.setBackground(new Color(0, 0, 128)); // Blue button
		...
		login.setFont(new Font("Comic Sans MS", Font.BOLD, 14));
		...
		loginpage.setFont(new Font("Comic Sans MS", Font.BOLD, 22));
